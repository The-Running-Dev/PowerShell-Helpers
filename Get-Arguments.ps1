function Get-Arguments {
    ...
    $packageArgs.skipSettings = Get-Argument $arguments 'skipSettings' $false
    ...
    if (-not (Test-FileExists $packageArgs.fileFullPath)) {
    ...
    Write-Message "Get-Arguments: $($packageArgs.GetEnumerator() |
        Sort-Object { $_.Name  } | Out-String)"
